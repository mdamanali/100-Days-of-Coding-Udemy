"""
In this project I have learned about Turtle Graphics.
"""
# There are functions already written inside turtle module.
# we just need to import that and use it accordingly
